          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="pt-4 border-t border-gray-800">
              <button
                ...
                className="w-full bg-gradient-to-r from-green-600 to-emerald-500 text-white py-3 px-6 rounded-lg font-semibold text-lg hover:opacity-90 transition duration-200 flex items-center justify-center gap-3 mb-4"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                Get Started (Students & Educators)
              </button>
        ...
        <div className="mt-16 w-full max-w-6xl px-4">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-black/50 border border-gray-800 rounded-xl p-6">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Class Management</h3>
              <p className="text-gray-400">
