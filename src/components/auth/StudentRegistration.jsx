      ...
      >
        ...
        >
          ...
          <div className="overflow-y-auto p-5 space-y-5 text-sm text-gray-300 leading-relaxed">
            <section>
              <h3 className="text-blue-400 font-semibold text-base mb-2">Terms of Service</h3>
              <p className="mb-2">
                By registering as a student on <span className="text-white font-medium">Beyond The Brush</span>, you agree to the following terms:
              </p>
            ...
            <section>
              <h3 className="text-blue-400 font-semibold text-base mb-2">Privacy Policy</h3>
              <p className="mb-2">
                We are committed to protecting your personal information. Here's how we handle your data:
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-400">
                <li>We collect your name, email, username, and academic information for account management.</li>
            ...
            <section>
              <h3 className="text-blue-400 font-semibold text-base mb-2">Student Responsibilities</h3>
              <ul className="list-disc list-inside space-y-1 text-gray-400">
                <li>Access only the classes and materials you are enrolled in.</li>
                <li>Do not share class access codes with unauthorized individuals.</li>
                <li>Report any platform issues or misuse to your educator or administrator.</li>
              </ul>
            </section>
          ...
          <div className="p-5 border-t border-gray-700">
            <button
              onClick={onClose}
              className="w-full bg-blue-500 hover:bg-blue-600 text-white py-2.5 rounded-lg font-medium transition duration-200"
            >
              I Understand
            </button>
          </div>
...
export default function StudentRegistration() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-start justify-center px-4 py-8 sm:py-12 relative">
      <AnimatedBackground />
      ...
      <div className="w-full max-w-2xl relative z-10">
        ...
        <motion.div
          ...
          className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 sm:p-8"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="bg-black/40 border border-gray-800 rounded-xl p-5 space-y-4">
              <h3 className="text-white font-medium">Academic Information</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start">
                {/* School */}
                <div>
            ...
            <div className="flex items-start gap-3 rounded-xl border border-gray-800 bg-black/40 px-4 py-3">
              <input
                type="checkbox"
                id="terms"
              ...
              <label htmlFor="terms" className="text-sm leading-6 text-gray-400">
                ...
                <button
                  ...
                  className="text-blue-400 hover:text-blue-300 underline underline-offset-2 transition duration-200"
                >
